...
def newMenuItem(restaurant_id):
    if request.method == 'POST':
        newItem = MenuItem(name=request.form['name'], discription=request.form[
                           'discription'], price=request.form['price'], course=request.form['course'], restaurant_id=restaurant_id)
        session.add(newItem)
        session.commit()
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        if request.form['discription']:
            editedItem.discount = request.form['name']
